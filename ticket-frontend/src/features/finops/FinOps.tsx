...
export default function FinOps({ onBack }: FinOpsProps) {
  return (
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Financial Operations & Cloud Cost Management
          </p>
        </div>
        <button
          onClick={onBack}
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-md">
            FinOps features will help you optimize cloud costs, track budgets, and manage financial operations efficiently.
          </p>
          <div className="inline-block px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl">
            Under Development
          </div>
        </div>
      </div>
